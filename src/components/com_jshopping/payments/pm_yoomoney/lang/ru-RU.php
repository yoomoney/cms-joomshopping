...
define('_JSHOP_YOO_ENABLE_HOLD_MODE_HELP', 'Если опция включена, платежи с карт проходят в 2 этапа: у клиента сумма замораживается, и вам вручную нужно подтвердить её списание – через панель администратора. <a href="https://yookassa.ru/features-pre-authorisation.html" target="_blank">Подробное описание Холдирования.</a>');
