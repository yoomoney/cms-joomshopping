...
echo JHtml::_('bootstrap.addTab', 'yamTab', 'money-tab', _JSHOP_YOO_TAB_MONEY);
    ...
    <div class="span4 offset2">
        <div class='form-horizontal'>
            <div class="form-group">
                ...
                <?php if(isSelected($params, 'moneymode')) echo "checked"; ?> /><?php echo _JSHOP_YOO_MONEY_ON; ?>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="span11 offset1">
        <div class="form-group">
            <div class="span2"><label for="pm_params[account]"><?php echo _JSHOP_YOO_MONEY_WALLET; ?></label></div>
            <div class="span8">
...
<div class="row">
    <div class="span11 offset1">
        <div class="form-group">
            <div class="span2"><label for="pm_params[password]" class="span2"><?php echo _JSHOP_YOO_MONEY_PSW; ?></label></div>
            <div class="span8">
...
<div class="row">
    <div class="span11 offset1">
        <div class="span2"><label><?php echo _JSHOP_YOO_MONEY_SELECT_LABEL; ?></label></div>
        <div class="span8">
            <?php
...
<div class="row">
    <div class="span11 offset1">
        <div class="form-group">
            <div class="span2"><label for="pm_params[money_transaction_end_status]"><?php echo _JSHOP_YOO_COMMON_STATUS; ?></label></div>
            <div class="span8">
                <?php
