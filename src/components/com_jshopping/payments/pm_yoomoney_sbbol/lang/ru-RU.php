...
define('_JSHOP_YOO_ENABLE_HOLD_MODE_HELP', 'Если опция включена, платежи с карт проходят в 2 этапа: у клиента сумма замораживается, и вам вручную нужно подтвердить её списание – через панель администратора. <a href="https://yookassa.ru/features/#10" target="_blank">Подробное описание Холдирования.</a>');
...
define('_JSHOP_YOO_MONEY_HEAD', 'Для работы с модулем нужно <a href="https://yoomoney.ru/" target="_blank">открыть кошелек</a> на ЮMoney и
