...
define('_JSHOP_YOO_LICENSE_TEXT',"To start operating the module, connect your store to <a target=\"_blank\" href=\"https://yookassa.ru/en/\">YooMoney for business</a>.");
...
define('_JSHOP_YOO_ENABLE_HOLD_MODE_HELP', 'If the option is enabled, payments are processed in two steps: first, the required amount is blocked on the customer’s card, and then you need to manually capture it via the administrator’s dashboard. <a href="https://yookassa.ru/features-pre-authorisation.html" target="_blank">Learn more at.</a>');
...
define('_JSHOP_YOO_MONEY_REDIRECT_HELP', "Copy this link to the Redirect URL field at the <a href='https://yoomoney.ru/myservices/online.xml' target='_blank'>notifications settings page</a>.");
